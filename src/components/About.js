  ...
  return (
    <section id="about">
      ...
      <div className="container mx-auto flex flex-col items-center">
        <h1 className="title-font py-5 text-8xl mb-4 text-pink-900 font-bold text-center sm:text-2xl">
          TRUCK CLUB AT <br></br>
          VIRGINIA TECH
        </h1>
        <p className="mb-8 py-5 text-1xl text-black leading-relaxed text-center sm:text-md">
      ...
      <div className="container py-30 mx-auto flex-col items-center bg-pink-900 max-w-full">
        ...
        <h1 className="title-font px-10 text-6xl mb-4 text-white font-bold text-center sm:text-xl">
          FEATURED ITEM
        </h1>
        <h1 className="title-font px-10 text-4xl mb-4 text-white font-semibold text-center sm:text-lg">
          TCVT ADOPTS A HIGHWAY
        </h1>
        <p className="mb-8 px-10 text-2xl text-white leading-relaxed text-center sm:text-md">
