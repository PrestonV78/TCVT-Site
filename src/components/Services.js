...
export default function Services() {
  return (
    <section id="Services" className="relative">
      <div className="container h-10 x-full flex py-15 bg-pink-900 items-center"></div>
      <div className="container mt-5 mx-auto flex flex-col items-center">
        ...
        <h1 className="title-font px-10 sm:text-3xl text-xl mb-4 text-black font-semibold text-center ">
        ...
        <div className="container h-3 x-full flex py-15 bg-pink-900 items-center"></div>
        <p className="mb-8 px-20 text-md text-black leading-relaxed text-center">
          Currently, TCVT is providing 2 services to assist the community around us.
        </p>
        <div className="container h-3 mx-auto flex px-10 py-5 "></div>
        <p className="mb-8 px-20 text-md text-black font-semibold text-center">
