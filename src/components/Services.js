  ...
  return (
    <section id="Services" className="relative">
      <div className="container mx-auto flex flex-col items-center">
        ...
        <h1 className="title-font sm:text-5xl text-2xl mb-4text-pink-900 font-bold text-center">
          TCVT SERVICES
        </h1>
        <h1 className="title-font px-35 mx-35 sm:text-2xl text-lg mb-4 text-black font-semibold text-center ">
        ...
        <p className="px-35 mx-35 text-md text-black leading-relaxed mb-4 text-center">
          Currently, TCVT is providing 2 services to assist the community around us.
        </p>
        <p className="px-35 mx-35 text-md text-black font-semibold mb-4 text-center">
