...
export default function Sponsors() {
  return (
    <section id="Sponsors" className="relative">
      ...
      <h1 className="title-font px-35 mx-35 sm:text-4xl text-2xl mb-8 text-black font-semibold text-center ">
      ...
      <div className="container w-full flex flex-col bg-white ">
        <div className="container mx-auto w-2/3 flex flex-row bg-pink-900 py-5 ">
