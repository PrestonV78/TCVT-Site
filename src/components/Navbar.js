...
export default function Navbar() {
  return (
    <header className="bg-black md:sticky top-0 z-10">
      <div className="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center w-80">
        <img
      ...
      <div className="container mx-auto flex px-1 py-2 bg-white md:flex-row flex-col items-center">
      </div>
