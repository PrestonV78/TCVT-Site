...
export default function Sponsors() {
  return (
    <section id="Sponsors" className="relative">
      <div className="container h-30 mx-auto flex  py-5 "></div>
      <h1 className="title-font sm:text-6xl text-3xl text-pink-900 font-bold text-center">
        BECOME A SPONSOR
      </h1>
      <div className="container h-5 mx-auto flex  py-5 "></div>
      ...
      <div className="container w-full flex flex-row bg-white ">
        ...
        <div className="container mx-auto w-5/6 flex-row flex bg-pink-900 py-5 ">
          ...
          <div className="container w-1/2 flex-col flex  py-5 ">
          ...
          <div className="container h-10 mx-auto flex bg-white  py-5 "></div>
        </div>
