...
export default function Navbar() {
  return (
    <header className="bg-black md: top-0 z-10">
      ...
      <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row justify-center">
        <nav className="md:mr-auto md:ml-4 md:py-1 px-20 md:pl-4 flex flex-wrap justify-center">
