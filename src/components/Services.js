...
export default function Services() {
  return (
    <section id="Services" className="relative">
      <div className="container h-15 w-full flex py-15 bg-pink-900 items-center"></div>
      <div className="container mx-auto flex flex-col items-center">
        ...
        <p className="px-35 text-md text-black leading-relaxed mb-4 text-center">
          Currently, TCVT is providing 2 services to assist the community around us.
        </p>
        <p className="px-35 text-md text-black font-semibold mb-4 text-center">
